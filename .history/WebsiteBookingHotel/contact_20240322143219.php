        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                <div class="bg-white rounded shadow p-4 ">
                    ...
                    <h5>Address</h5>
                    <a href="https://maps.app.goo.gl/TkpwJFueXijHawj1A">
                        <i class="bi bi-geo-alt-fill">28 Đường Thi Sách, Phường 8, Thành phố Vũng Tầu,
                            Bà Rịa - Vũng Tàu 78000, Việt Nam</i>
