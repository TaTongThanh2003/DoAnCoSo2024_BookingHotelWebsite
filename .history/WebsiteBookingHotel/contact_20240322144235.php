            ...
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                <div class="bg-white rounded shadow p-4 ">
                    ...
                    <a href="Mail To: tuongthanh14122003@gmail.com "
                        class="d-inline-block text-decoration-none text-dark">Tuongthanh14122003@gmail.com</a><br>
                    <a href="MailTo: phannhattruong@gmail.com "
                        class="d-inline-block text-decoration-none text-dark">phannhattruong@gmail.com</a>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 mb-5 px-4">
