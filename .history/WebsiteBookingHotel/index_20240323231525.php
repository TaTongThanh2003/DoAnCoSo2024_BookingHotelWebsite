...
<body class="bg-light">
                ...
                <form>
                    <div class="row align-item-end">
                        ...
                        <div class="col-lg-1 mb-lg-3 mt-2">
                            <button type="submit" class="btn text-white shadow-none custom-bg">Đặt Ngay</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <!-- Our Rooms -->
    <h2 class="mt-5 mb-4 text-center fw-bold h-font">Hệ Thống Phòng</h2>
    ...
    <div class="container">
        <div class="row">
                ...
                <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly mb-2">
                            <a href="#" class="btn btn-sm text-white custom-bg shadow-none">Đặt ngay</a>
            ...
            <div class="col-lg-12 text-center mt-5">
                <a href="" class="btn btn-outline-dark rounded-0 fw-bold shadow-none">Xem thêm phòng >>></a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
            ...
            <div class="col-lg-12 text-center mt-5">
                <a href="" class="btn btn-outline-dark rounded-0 fw-bold shadow-none">Xem thêm tiện ích >>></a>
    ...
    <!-- Testimonials -->
    <h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font">Nhận Xét</h2>
