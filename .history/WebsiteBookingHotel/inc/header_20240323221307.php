<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">2T Hotel</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="rooms.php">Hệ Thống Phòng</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="facilities.php">Tiện ích</a>
                </li>
                <li class="nav-item">
            ...
            <form>
                ...
                <div class="modal-body">
                    <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                        ...
                        that will be required dring check-in.
                    </span>
                    <div class="container-fluid">
                        <div class="row">
                            <!-- Name -->
