...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        <h2 class="fw-bold h-font text-center">HỆ THỐNG PHÒNG</h2>
                ...
                <div class="card mb-4 border-0 shadow">
                    <div class="row g-0 p-3 align-items-center ">
                        ...
                        <div class="col-md-5 px-lg-3 px-md-3 px-0">
                            <h5 class="mb-1">Căn 1 Phòng Ngủ</h5>
                            <div class="features mb-3 px-lg-3">
                            ...
                            <div class="facilities mb-3 px-lg-3">
